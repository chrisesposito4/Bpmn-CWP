...
public abstract class BPMNElement implements BPMNValidator {
    ...
    public String getPromelaCode() {
        return this.getChildNodeContent(BPMNNS.VERIFY_CWP, "promela_code");
    }
    
     public String getSrcProv() {
        return this.getChildNodeContent(BPMNNS.VERIFY_CWP, "src_provenance");
    }
     
      public String getDestProv() {
        return this.getChildNodeContent(BPMNNS.VERIFY_CWP, "dest_provenance");
    }
	...
	public void setPromelaCode(String content)
	{
		this.setChildNodeContent(BPMNNS.VERIFY_CWP, "promela_code", content, true);
	}
	
	public void setSrc_Provenance(String content)
	{
		this.setChildNodeContent(BPMNNS.VERIFY_CWP, "src_provenance", content, true);
	}
	
	public void setDest_Provenance(String content)
	{
		this.setChildNodeContent(BPMNNS.VERIFY_CWP, "dest_provenance", content, true);
	}
